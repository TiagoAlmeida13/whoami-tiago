...
- No frameworks or build step — just HTML, CSS and vanilla JS
...
```bash
git clone https://github.com/TiagoAlmeida13/whoami-tiago.git
cd whoami-tiago
open index.html
```
...
- Email: [tyygo@live.com](mailto:tyygo@live.com)
- GitHub: [@TiagoAlmeida13](https://github.com/TiagoAlmeida13)
- Twitter: [@tyygo](https://twitter.com/tyygo)
